  ...
  return (
    ...
    >
      <p>
        ...
        <strong>{BRAND.legalName}</strong>. It combines curriculum-aligned content
        with AI tutoring so every learner gets guidance that matches their level,
        pace, and goals — from school exams to career upskilling.
      </p>
      <h2>Our focus</h2>
      <ul>
