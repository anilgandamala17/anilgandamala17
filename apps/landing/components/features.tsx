...
function HeroExplainerCard() {
  return (
    <FeatureCardShell className="mx-auto mb-10 max-w-4xl md:mb-16">
      <div className="group/media relative aspect-video w-full overflow-hidden bg-slate-900">
        <div
          className="absolute inset-0 z-[2] flex flex-col items-center justify-center gap-3 bg-slate-900 px-6 text-center"
          role="img"
          aria-label="Explainer video unavailable"
        >
          <Image
            src={BRAND.iconSrc}
            alt=""
            width={96}
            height={96}
            className="size-16 object-contain opacity-80 md:size-20"
          />
          <p className="text-sm text-slate-200">Video unavailable — try again later</p>
        </div>
        <AiraMark />
      </div>
