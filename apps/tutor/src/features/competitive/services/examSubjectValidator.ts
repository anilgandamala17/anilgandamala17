...
} from '@/features/competitive/data/competitive/subjectDiscipline';
...
export interface SubjectValidationContext {
  ...
  scienceDiscipline?: import('@/features/competitive/data/competitive/subjectDiscipline').ScienceDiscipline;
}
