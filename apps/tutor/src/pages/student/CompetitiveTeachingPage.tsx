...
import { loadExplainPayload, saveExplainPayload, type ExplainPayload } from '@/features/competitive/lib/competitiveRoute';
...
export default function CompetitiveTeachingPage() {
    ...
    // Generation finished with nothing usable — avoid blank "1 / 0" shell.
    if (question && !isGenerating && steps.length === 0) {
        return (
            <div className="min-h-screen flex items-center justify-center p-6">
                <div className="text-center max-w-sm">
                    <div className="w-16 h-16 rounded-2xl bg-red-100 dark:bg-red-900/20 flex items-center justify-center mx-auto mb-4">
                    ...
                    <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-2">Explanation Unavailable</h2>
                    <p className="text-slate-500 dark:text-slate-400 mb-6">
                        Could not build an AI explanation for this question. Please try again from Competitive Mode.
                    </p>
                    <button onClick={goBackToCompetitive} className="rounded-2xl bg-orange-600 px-8 py-3 font-bold text-white shadow-lg shadow-orange-500/30 transition-colors hover:bg-orange-700">
                        Back to Competitive
                    </button>
