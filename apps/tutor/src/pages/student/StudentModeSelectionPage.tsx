...
import ModeSelectionNavbar from '@/features/mode-selection/ModeSelectionNavbar';
import ModeSelectionHero from '@/features/mode-selection/ModeSelectionHero';
import ModeCard, { type ModeAccent } from '@/features/mode-selection/ModeCard';
import ModeSelectionFooter from '@/features/mode-selection/ModeSelectionFooter';
import { enterStudentMode, type StudentMode } from '@/lib/navigation';
import { analytics } from '@/services/analyticsService';
import '@/features/mode-selection/mode-selection.css';
