...
import { getExamSourcePolicy } from '../data/competitive/examSourcePolicy';
import { lockScienceDiscipline } from '../data/competitive/subjectDiscipline';
